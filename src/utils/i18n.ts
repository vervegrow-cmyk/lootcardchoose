...
const dictionary: Record<SupportedLanguage, Record<string, string>> = {
  zh: {
    ...
    "gallery.search.resultTitle": "卡牌 {index}: {title}",
    ...
    "gallery.refresh.needClarification": "你想换成什么风格？比如可爱、暗黑、幻想或高级感。",
    "gallery.refresh.poolExhausted":
      "和当前方向接近的卡牌我已经基本展示完了。告诉我一个新的风格、颜色或主题，我再继续帮你找。",
    "checkout.creating": "正在创建商品链接，请稍候。",
    "checkout.success": "你的商品链接已准备好。",
    "checkout.failed": "暂时无法创建商品链接，请稍后再试。",
    "order.status.notFound": "暂时没有找到订单记录。",
    "order.status.current": "当前订单状态: {status}",
    "order.paid.title": "✅ 用户订单已支付",
    "order.paid.number": "订单号：{orderNumber}",
    "order.paid.amount": "金额：${amount}",
    "help.message": "告诉我你想要的风格、颜色、稀有度或角色类型，我会帮你找到合适的卡牌。",
  ...
  en: {
    ...
    "order.paid.title": "✅ Your order has been paid",
    "order.paid.number": "Order number: {orderNumber}",
    "order.paid.amount": "Amount: ${amount}",
