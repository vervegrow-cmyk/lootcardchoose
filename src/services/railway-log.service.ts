...
const buildMockLines = (): OpsLogLine[] => [
  ...
  },
  {
    ...
    level: "warn",
    message: "RAILWAY_TOKEN=[REDACTED_SECRET_EXAMPLE]",
  },
  {
    timestamp: "2026-05-14T00:04:10.000Z",
    level: "warn",
    message: "[LLM INTENT CLASSIFIER] timeout Authorization: Bearer example-token-placeholder",
  },
  {
    timestamp: "2026-05-14T00:05:15.000Z",
    level: "error",
    message: "[DISCORD] handler error code=error.generic token=discord_bot_token_abcdefghijklmnopqrstuvwxyz",
  },
  {
